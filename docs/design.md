...
*   **B. 头部信息 (`Header`)**
    *   **格式:** `LIFE CLOCK :: [ANCHOR] :: [TIME_METRIC]`
    *   **`[ELAPSED]` 模式下:** `LIFE CLOCK :: BORN 1988/07/23 :: ELAPSED: 35y 11m 21d ...`
    *   **`[REMAINING]` 模式下:** `LIFE CLOCK :: EOL 2068/07/23 :: REMAINING: 44y 0m 8d ...`
...
```
+------------------------------------------------------------------------------+
| LIFE CLOCK :: BORN 1988/07/23 :: ELAPSED: 35y 11m 21d 18:31:52.891         |
|==============================================================================|
|                                                                              |
|                     2024 / 07 / 14 | SATURDAY                                 |
|                                                                              |
